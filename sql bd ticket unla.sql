...
CREATE TABLE IF NOT EXISTS `TicketUnla`.`Auditorio` (
  ...
  `filasAuditorio` INT NOT NULL,
  `columnasAuditorio` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `TicketUnla`.`ButacaxSeccion` (
  ...
  `Seccion_idSeccion` INT NOT NULL,
  PRIMARY KEY (`Butaca_idButaca`, `Seccion_idSeccion`),
...
CREATE TABLE IF NOT EXISTS `TicketUnla`.`CodigoDescuento` (
  `idCodigoDescuento` INT NOT NULL,
