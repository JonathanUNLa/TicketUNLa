...
public class ControladorTicketClienteBeneficioFecha extends HttpServlet{
	...
	private void procesarPeticion(HttpServletRequest request, HttpServletResponse response) 
		...
		try {
			...
			int idbeneficio = Integer.parseInt(request.getParameter("beneficio"));
			...
			List<Entrada> lista= eabm.traerEntradasTipoBeneficio(idbeneficio,f1,f2);
			TipoBeneficio bene= tabm.traerTipoBeneficio(idbeneficio);
			...
			if(error==0){
			response.sendError(500, "hubo un problemas en algo");
			}
