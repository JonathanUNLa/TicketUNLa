	...
	<section id="content">
		...
		<div class="grid_8">
			...
			<FORM method="POST" action="/TicketUNLaWEB/reservar2">
				...
				<p>
					<label> <input class="with-gap" name="idauditorio"
						type="radio" id="idauditorio"
						value="<%=auditorio.getIdAuditorio()%>" checked /> <span><%=auditorio.getNombre()%></span>
					</label>
				</p>
				<br> <br>
				------------------------------------------------------------
