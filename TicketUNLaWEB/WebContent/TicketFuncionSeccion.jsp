...
<!--==============================header=================================-->
		...
		<section id="content">
				<div class="grid_8">
					...
					%>
					<%
					Auditorio auditorio = (Auditorio) request.getAttribute("auditorio");
					%>
					<%int id= (int) request.getAttribute("idfuncion"); %>
					
						<FORM method="POST" action="/TicketUNLaWEB/TicketFuncionSeccionResultado">
						<p>Secciones del auditorio :  <%=auditorio.getNombre() %> </p>
