...
<!--==============================header=================================-->
		...
		<%
					...
					<FORM method="POST" action="/TicketUNLaWEB/altaauditorios">
					<INPUT type="hidden" id="idusuario" name="idusuario"
					value="<%=u.getIdUsuario()%>" /> <input type="submit"
					id="id" value="alta">
					</FORM>
					
					<FORM method="POST" action="/TicketUNLaWEB/bajaauditorios">
					<INPUT type="hidden" id="idusuario" name="idusuario"
					value="<%=u.getIdUsuario()%>" /> <input type="submit"
					id="id" value="baja">
					</FORM>
					
					<FORM method="POST" action="/TicketUNLaWEB/modificacionauditorios">
					<INPUT type="hidden" id="idusuario" name="idusuario"
					value="<%=u.getIdUsuario()%>" /> <input type="submit"
