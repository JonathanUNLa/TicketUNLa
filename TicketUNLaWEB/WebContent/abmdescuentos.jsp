...
<!--==============================header=================================-->
		...
		<%
					...
					<FORM method="POST" action="/TicketUNLaWEB/altadescuentos">
					<INPUT type="hidden" id="idusuario" name="idusuario"
					value="<%=u.getIdUsuario()%>" /> <input type="submit"
					id="id" value="alta">
					</FORM>
					
					<FORM method="POST" action="/TicketUNLaWEB/bajadescuentos">
					<INPUT type="hidden" id="idusuario" name="idusuario"
					value="<%=u.getIdUsuario()%>" /> <input type="submit"
					id="id" value="baja">
					</FORM>
					
					<FORM method="POST" action="/TicketUNLaWEB/modificaciondescuentos">
					<INPUT type="hidden" id="idusuario" name="idusuario"
					value="<%=u.getIdUsuario()%>" /> <input type="submit"
