...
<!--==============================header=================================-->
		...
		Clientes
		<%
					List<Auditorio> la = (List<Auditorio>) request.getAttribute("la");
					%>
					
					
					<FORM method="POST" action="/TicketUNLaWEB/auditorioseliminados">
					...
					<p>
					Columna:
					<input type="checkbox" id="idauditorio" name="idauditorio" value="<%= a.getIdAuditorio() %>" ><%= a.getNombre() %><br>
					<br>
