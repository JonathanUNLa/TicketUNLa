...
public class EntradaABM {
	...
	public int agregar(Butaca butaca,Usuario usuario, Funcion funcion, String codigo, Reserva reserva) {
		Entrada entrada = new Entrada(butaca,usuario,funcion, codigo, reserva);
